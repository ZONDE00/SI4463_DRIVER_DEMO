...
#ifndef RADIO_CONFIG_RTTY_H_
#define RADIO_CONFIG_RTTY_H_
...
// INPUT DATA
/*
// Crys_freq(Hz): 26000000    Crys_tol(ppm): 0.5    IF_mode: 2    High_peRF_RTTY_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 15
// MOD_type: 2    Rsymb(sps): 1000    Fdev(Hz): 300    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2
// RF Freq.(MHz): 433.3    API_TC: 29    fhst: 600    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 1    Hi_pfm_div: 1
// API_ARR_Det_en: 0    Fdev_error: 0    API_ETSI: 0
//
// # RX IF frequency is  -406250 Hz
// # WB filter 3 (BW =   2.51 kHz);  NB-filter 3 (BW = 2.51 kHz)
//
...
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_XO_FREQ                     26000000L
#define RADIO_CONFIGURATION_DATA_RTTY_CHANNEL_NUMBER                         0x00
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PACKET_LENGTH               0x00
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_STATE_AFTER_POWER_UP        0x03
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_DELAY_CNT_AFTER_RESET       0xF000


// CONFIGURATION COMMANDS

/*
// Command:                  RF_RTTY_POWER_UP
// Description:              Command to power-up the device and select the operational mode and functionality.
*/
#define RF_RTTY_POWER_UP 0x02, 0x01, 0x01, 0x01, 0x8C, 0xBA, 0x80

/*
// Command:                  RF_RTTY_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
*/
#define RF_RTTY_GPIO_PIN_CFG 0x13, 0x04, 0x10, 0x03, 0x02, 0x00, 0x00, 0x40

/*
// Set properties:           RF_RTTY_GLOBAL_XO_TUNE_2
...
*/
#define RF_RTTY_GLOBAL_XO_TUNE_2 0x11, 0x00, 0x02, 0x00, 0x00, 0x01

/*
// Set properties:           RF_RTTY_GLOBAL_CONFIG_1
...
*/
#define RF_RTTY_GLOBAL_CONFIG_1 0x11, 0x00, 0x01, 0x03, 0x20

/*
// Set properties:           RF_RTTY_INT_CTL_ENABLE_1
// Number of properties:     1
// Group ID:                 0x01
// Start ID:                 0x00
// Default values:           0x04,
...
*/
#define RF_RTTY_INT_CTL_ENABLE_1 0x11, 0x01, 0x01, 0x00, 0x00

/*
// Set properties:           RF_RTTY_FRR_CTL_A_MODE_4
...
*/
#define RF_RTTY_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_RTTY_PREAMBLE_CONFIG_1
// Number of properties:     1
// Group ID:                 0x10
// Start ID:                 0x04
// Default values:           0x21,
...
*/
#define RF_RTTY_PREAMBLE_CONFIG_1 0x11, 0x10, 0x01, 0x04, 0x21

/*
// Set properties:           RF_RTTY_MODEM_MOD_TYPE_12
...
*/
#define RF_RTTY_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x0A, 0x00, 0x07, 0x00, 0x27, 0x10, 0x01, 0x8C, 0xBA, 0x80, 0x00, 0x00

/*
// Set properties:           RF_RTTY_MODEM_FREQ_DEV_0_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x0C
// Default values:           0xD3,
...
*/
#define RF_RTTY_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x18

/*
// Set properties:           RF_RTTY_MODEM_TX_RAMP_DELAY_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x18
...
*/
#define RF_RTTY_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0xF0, 0x20, 0x34, 0xE8, 0x00, 0x66

/*
// Set properties:           RF_RTTY_MODEM_BCR_NCO_OFFSET_2_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x24
...
*/
#define RF_RTTY_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x05, 0x0A, 0x8E, 0x02, 0x83, 0x00, 0xC2, 0x00, 0x54, 0x23, 0x80, 0x0B

/*
// Set properties:           RF_RTTY_MODEM_AFC_LIMITER_1_3
...
*/
#define RF_RTTY_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x02, 0x06, 0x80

/*
// Set properties:           RF_RTTY_MODEM_AGC_CONTROL_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x35
// Default values:           0xE0,
...
*/
#define RF_RTTY_MODEM_AGC_CONTROL_1 0x11, 0x20, 0x01, 0x35, 0xE0

/*
// Set properties:           RF_RTTY_MODEM_AGC_WINDOW_SIZE_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x38
...
*/
#define RF_RTTY_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x16, 0x16, 0x80, 0x02, 0x26, 0x66, 0x00, 0x28, 0x0C, 0x84, 0x23

/*
// Set properties:           RF_RTTY_MODEM_RAW_CONTROL_5
...
*/
#define RF_RTTY_MODEM_RAW_CONTROL_5 0x11, 0x20, 0x05, 0x45, 0x8F, 0x00, 0xBD, 0x01, 0x00

/*
// Set properties:           RF_RTTY_MODEM_RSSI_JUMP_THRESH_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x4B
// Default values:           0x0C,
...
*/
#define RF_RTTY_MODEM_RSSI_JUMP_THRESH_1 0x11, 0x20, 0x01, 0x4B, 0x06

/*
// Set properties:           RF_RTTY_MODEM_RSSI_CONTROL2_2
// Number of properties:     2
// Group ID:                 0x20
// Start ID:                 0x4D
...
*/
#define RF_RTTY_MODEM_RSSI_CONTROL2_2 0x11, 0x20, 0x02, 0x4D, 0x18, 0x40

/*
// Set properties:           RF_RTTY_MODEM_RAW_SEARCH2_2
// Number of properties:     2
// Group ID:                 0x20
// Start ID:                 0x50
...
*/
#define RF_RTTY_MODEM_RAW_SEARCH2_2 0x11, 0x20, 0x02, 0x50, 0x94, 0x0A

/*
// Set properties:           RF_RTTY_MODEM_SPIKE_DET_2
// Number of properties:     2
// Group ID:                 0x20
// Start ID:                 0x54
...
*/
#define RF_RTTY_MODEM_SPIKE_DET_2 0x11, 0x20, 0x02, 0x54, 0x03, 0x07

/*
// Set properties:           RF_RTTY_MODEM_RSSI_MUTE_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x57
// Default values:           0x00,
...
*/
#define RF_RTTY_MODEM_RSSI_MUTE_1 0x11, 0x20, 0x01, 0x57, 0x00

/*
// Set properties:           RF_RTTY_MODEM_DSA_CTRL1_5
// Number of properties:     5
// Group ID:                 0x20
// Start ID:                 0x5B
...
*/
#define RF_RTTY_MODEM_DSA_CTRL1_5 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x07, 0x78, 0x20

/*
// Set properties:           RF_RTTY_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x00
...
*/
#define RF_RTTY_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12 0x11, 0x21, 0x0C, 0x00, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1, 0xB9, 0xC9, 0xEA, 0x05, 0x12, 0x11

/*
// Set properties:           RF_RTTY_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x0C
...
*/
#define RF_RTTY_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0x0A, 0x04, 0x15, 0xFC, 0x03, 0x00, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1

/*
// Set properties:           RF_RTTY_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x18
...
*/
#define RF_RTTY_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12 0x11, 0x21, 0x0C, 0x18, 0xB9, 0xC9, 0xEA, 0x05, 0x12, 0x11, 0x0A, 0x04, 0x15, 0xFC, 0x03, 0x00

/*
// Set properties:           RF_RTTY_PA_MODE_4
// Number of properties:     4
// Group ID:                 0x22
// Start ID:                 0x00
...
*/
#define RF_RTTY_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x08, 0x02, 0x00, 0x1D

/*
// Set properties:           RF_RTTY_SYNTH_PFDCP_CPFF_7
...
*/
#define RF_RTTY_SYNTH_PFDCP_CPFF_7 0x11, 0x23, 0x07, 0x00, 0x2C, 0x0E, 0x0B, 0x04, 0x0C, 0x73, 0x03

/*
// Set properties:           RF_RTTY_FREQ_CONTROL_INTE_8
...
*/
#define RF_RTTY_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x41, 0x0D, 0x4A, 0xD4, 0x00, 0x30, 0x20, 0xFE
...
#define RADIO_CONFIGURATION_DATA_RTTY_ARRAY { \
        0x07, RF_RTTY_POWER_UP, \
        0x08, RF_RTTY_GPIO_PIN_CFG, \
        0x06, RF_RTTY_GLOBAL_XO_TUNE_2, \
        0x05, RF_RTTY_GLOBAL_CONFIG_1, \
        0x05, RF_RTTY_INT_CTL_ENABLE_1, \
        0x08, RF_RTTY_FRR_CTL_A_MODE_4, \
        0x05, RF_RTTY_PREAMBLE_CONFIG_1, \
        0x10, RF_RTTY_MODEM_MOD_TYPE_12, \
        0x05, RF_RTTY_MODEM_FREQ_DEV_0_1, \
        0x10, RF_RTTY_MODEM_TX_RAMP_DELAY_12, \
        0x10, RF_RTTY_MODEM_BCR_NCO_OFFSET_2_12, \
        0x07, RF_RTTY_MODEM_AFC_LIMITER_1_3, \
        0x05, RF_RTTY_MODEM_AGC_CONTROL_1, \
        0x10, RF_RTTY_MODEM_AGC_WINDOW_SIZE_12, \
        0x09, RF_RTTY_MODEM_RAW_CONTROL_5, \
        0x05, RF_RTTY_MODEM_RSSI_JUMP_THRESH_1, \
        0x06, RF_RTTY_MODEM_RSSI_CONTROL2_2, \
        0x06, RF_RTTY_MODEM_RAW_SEARCH2_2, \
        0x06, RF_RTTY_MODEM_SPIKE_DET_2, \
        0x05, RF_RTTY_MODEM_RSSI_MUTE_1, \
        0x09, RF_RTTY_MODEM_DSA_CTRL1_5, \
        0x10, RF_RTTY_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, \
        0x10, RF_RTTY_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, \
        0x10, RF_RTTY_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, \
        0x08, RF_RTTY_PA_MODE_4, \
        0x0B, RF_RTTY_SYNTH_PFDCP_CPFF_7, \
        0x0C, RF_RTTY_FREQ_CONTROL_INTE_8, \
        0x00 \
 }
#else
#define RADIO_CONFIGURATION_DATA_RTTY_ARRAY { 0 }
#endif

// DEFAULT VALUES FOR CONFIGURATION PARAMETERS
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_XO_FREQ_DEFAULT                     30000000L
#define RADIO_CONFIGURATION_DATA_RTTY_CHANNEL_NUMBER_DEFAULT                    0x00
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PACKET_LENGTH_DEFAULT               0x10
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_STATE_AFTER_POWER_UP_DEFAULT        0x01
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_DELAY_CNT_AFTER_RESET_DEFAULT       0x1000

#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PATCH_INCLUDED                      0x00
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PATCH_SIZE                          0x00
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PATCH                               {  }

#ifndef RADIO_CONFIGURATION_DATA_RTTY_ARRAY
#error "This property must be defined!"
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_XO_FREQ
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_XO_FREQ          RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_XO_FREQ_DEFAULT
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_CHANNEL_NUMBER
#define RADIO_CONFIGURATION_DATA_RTTY_CHANNEL_NUMBER         RADIO_CONFIGURATION_DATA_RTTY_CHANNEL_NUMBER_DEFAULT
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PACKET_LENGTH
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PACKET_LENGTH    RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PACKET_LENGTH_DEFAULT
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_STATE_AFTER_POWER_UP
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_STATE_AFTER_POWER_UP   RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_STATE_AFTER_POWER_UP_DEFAULT
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_DELAY_CNT_AFTER_RESET
#define RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_DELAY_CNT_AFTER_RESET  RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_DELAY_CNT_AFTER_RESET_DEFAULT
#endif

#define RADIO_CONFIGURATION_DATA_RTTY { \
                            RADIO_CONFIGURATION_DATA_RTTY_Array,                            \
                            RADIO_CONFIGURATION_DATA_RTTY_CHANNEL_NUMBER,                   \
                            RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_PACKET_LENGTH,              \
                            RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_STATE_AFTER_POWER_UP,       \
                            RADIO_CONFIGURATION_DATA_RTTY_RADIO_RTTY_DELAY_CNT_AFTER_RESET       \
                            }
