...
#ifndef RADIO_CONFIG_RTTY_30_H_
#define RADIO_CONFIG_RTTY_30_H_
...
// INPUT DATA
/*
// Crys_freq(Hz): 30000000    Crys_tol(ppm): 0.5    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 15    
// MOD_type: 2    Rsymb(sps): 100    Fdev(Hz): 300    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 433.3    API_TC: 29    fhst: 600    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 1    Hi_pfm_div: 1    
// API_ARR_Det_en: 0    Fdev_error: 0    API_ETSI: 0  RADIO_CONFIGURATION_DATA_RTTY_30_RTTY_RADIO
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 2 (BW =   1.61 kHz);  NB-filter 2 (BW = 1.61 kHz)
// 
// Modulation index: 6
*/
...
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_XO_FREQ                     30000000L
#define RADIO_CONFIGURATION_DATA_RTTY_30_CHANNEL_NUMBER                    0x00
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PACKET_LENGTH               0x00
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_STATE_AFTER_POWER_UP        0x03
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_DELAY_CNT_AFTER_RESET       0xF000
...
*/
#define RF_RTTY_30_POWER_UP 0x02, 0x81, 0x01, 0x01, 0xC9, 0xC3, 0x80

/*
// Command:                  RF_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
*/
#define RF_RTTY_30_GPIO_PIN_CFG 0x13, 0x04, 0x10, 0x03, 0x02, 0x00, 0x00, 0x40
...
*/
#define RF_RTTY_30_GLOBAL_XO_TUNE_2 0x11, 0x00, 0x02, 0x00, 0x00, 0x01
...
*/
#define RF_RTTY_30_GLOBAL_CONFIG_1 0x11, 0x00, 0x01, 0x03, 0x20
...
*/
#define RF_RTTY_30_INT_CTL_ENABLE_1 0x11, 0x01, 0x01, 0x00, 0x00
...
*/
#define RF_RTTY_30_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_RTTY_30_PREAMBLE_CONFIG_1 0x11, 0x10, 0x01, 0x04, 0x21
...
*/
#define RF_RTTY_30_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x0A, 0x00, 0x07, 0x00, 0x03, 0xE8, 0x01, 0xC9, 0xC3, 0x80, 0x00, 0x00
...
*/
#define RF_RTTY_30_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x15
...
*/
#define RF_RTTY_30_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0xF0, 0x20, 0x54, 0xE8, 0x02, 0x4A
...
*/
#define RF_RTTY_30_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x00, 0xDF, 0xB2, 0x00, 0x70, 0x00, 0xC2, 0x00, 0x54, 0x23, 0x80, 0x05
...
*/
#define RF_RTTY_30_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x01, 0xD5, 0x80
...
*/
#define RF_RTTY_30_MODEM_AGC_CONTROL_1 0x11, 0x20, 0x01, 0x35, 0xE0
...
*/
#define RF_RTTY_30_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x80, 0x80, 0x80, 0x02, 0xFF, 0xFF, 0x00, 0x2B, 0x0C, 0x84, 0x23
...
*/
#define RF_RTTY_30_MODEM_RAW_CONTROL_5 0x11, 0x20, 0x05, 0x45, 0x8F, 0x01, 0x47, 0x01, 0x00
...
*/
#define RF_RTTY_30_MODEM_RSSI_JUMP_THRESH_1 0x11, 0x20, 0x01, 0x4B, 0x06
...
*/
#define RF_RTTY_30_MODEM_RSSI_CONTROL2_2 0x11, 0x20, 0x02, 0x4D, 0x18, 0x40
...
*/
#define RF_RTTY_30_MODEM_RAW_SEARCH2_2 0x11, 0x20, 0x02, 0x50, 0x94, 0x0A
...
*/
#define RF_RTTY_30_MODEM_SPIKE_DET_2 0x11, 0x20, 0x02, 0x54, 0x04, 0x07
...
*/
#define RF_RTTY_30_MODEM_RSSI_MUTE_1 0x11, 0x20, 0x01, 0x57, 0x00
...
*/
#define RF_RTTY_30_MODEM_DSA_CTRL1_5 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x0C, 0x78, 0x20
...
*/
#define RF_RTTY_30_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12 0x11, 0x21, 0x0C, 0x00, 0xFF, 0xC4, 0x30, 0x7F, 0xF5, 0xB5, 0xB8, 0xDE, 0x05, 0x17, 0x16, 0x0C
...
*/
#define RF_RTTY_30_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0x03, 0x00, 0x15, 0xFF, 0x00, 0x00, 0xFF, 0xC4, 0x30, 0x7F, 0xF5, 0xB5
...
*/
#define RF_RTTY_30_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12 0x11, 0x21, 0x0C, 0x18, 0xB8, 0xDE, 0x05, 0x17, 0x16, 0x0C, 0x03, 0x00, 0x15, 0xFF, 0x00, 0x00
...
*/
#define RF_RTTY_30_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x08, 0x02, 0x00, 0x1D
...
*/
#define RF_RTTY_30_SYNTH_PFDCP_CPFF_7 0x11, 0x23, 0x07, 0x00, 0x2C, 0x0E, 0x0B, 0x04, 0x0C, 0x73, 0x03
...
*/
#define RF_RTTY_30_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x38, 0x0E, 0x2F, 0xC9, 0x00, 0x2A, 0x20, 0xFE
...
#define RADIO_CONFIGURATION_DATA_ARRAY_RTTY_30 { \
        0x07, RF_RTTY_30_POWER_UP, \
        0x08, RF_RTTY_30_GPIO_PIN_CFG, \
        0x06, RF_RTTY_30_GLOBAL_XO_TUNE_2, \
        0x05, RF_RTTY_30_GLOBAL_CONFIG_1, \
        0x05, RF_RTTY_30_INT_CTL_ENABLE_1, \
        0x08, RF_RTTY_30_FRR_CTL_A_MODE_4, \
        0x05, RF_RTTY_30_PREAMBLE_CONFIG_1, \
        0x10, RF_RTTY_30_MODEM_MOD_TYPE_12, \
        0x05, RF_RTTY_30_MODEM_FREQ_DEV_0_1, \
        0x10, RF_RTTY_30_MODEM_TX_RAMP_DELAY_12, \
        0x10, RF_RTTY_30_MODEM_BCR_NCO_OFFSET_2_12, \
        0x07, RF_RTTY_30_MODEM_AFC_LIMITER_1_3, \
        0x05, RF_RTTY_30_MODEM_AGC_CONTROL_1, \
        0x10, RF_RTTY_30_MODEM_AGC_WINDOW_SIZE_12, \
        0x09, RF_RTTY_30_MODEM_RAW_CONTROL_5, \
        0x05, RF_RTTY_30_MODEM_RSSI_JUMP_THRESH_1, \
        0x06, RF_RTTY_30_MODEM_RSSI_CONTROL2_2, \
        0x06, RF_RTTY_30_MODEM_RAW_SEARCH2_2, \
        0x06, RF_RTTY_30_MODEM_SPIKE_DET_2, \
        0x05, RF_RTTY_30_MODEM_RSSI_MUTE_1, \
        0x09, RF_RTTY_30_MODEM_DSA_CTRL1_5, \
        0x10, RF_RTTY_30_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, \
        0x10, RF_RTTY_30_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, \
        0x10, RF_RTTY_30_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, \
        0x08, RF_RTTY_30_PA_MODE_4, \
        0x0B, RF_RTTY_30_SYNTH_PFDCP_CPFF_7, \
        0x0C, RF_RTTY_30_FREQ_CONTROL_INTE_8, \
        0x00 \
 }
#else
#define RADIO_CONFIGURATION_DATA_RTTY_30 { 0 }
#endif

// DEFAULT VALUES FOR CONFIGURATION PARAMETERS
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_XO_FREQ_DEFAULT                     30000000L
#define RADIO_CONFIGURATION_DATA_RTTY_30_CHANNEL_NUMBER_DEFAULT                    0x00
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PACKET_LENGTH_DEFAULT               0x10
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_STATE_AFTER_POWER_UP_DEFAULT        0x01
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_DELAY_CNT_AFTER_RESET_DEFAULT       0x1000

#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PATCH_INCLUDED                      0x00
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PATCH_SIZE                          0x00
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PATCH                               {  }

#ifndef RADIO_CONFIGURATION_DATA_ARRAY_RTTY_30
#error "This property must be defined!"
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_XO_FREQ
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_XO_FREQ          RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_XO_FREQ_DEFAULT
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_30_CHANNEL_NUMBER
#define RADIO_CONFIGURATION_DATA_RTTY_30_CHANNEL_NUMBER         RADIO_CONFIGURATION_DATA_RTTY_30_CHANNEL_NUMBER_DEFAULT
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PACKET_LENGTH
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PACKET_LENGTH    RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PACKET_LENGTH_DEFAULT
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_STATE_AFTER_POWER_UP
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_STATE_AFTER_POWER_UP   RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_STATE_AFTER_POWER_UP_DEFAULT
#endif

#ifndef RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_DELAY_CNT_AFTER_RESET
#define RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_DELAY_CNT_AFTER_RESET  RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_DELAY_CNT_AFTER_RESET_DEFAULT
#endif

#define RADIO_CONFIGURATION_DATA_RTTY_30 { \
                            RADIO_CONFIGURATION_DATA_RTTY_30_Array,                            \
                            RADIO_CONFIGURATION_DATA_RTTY_30_CHANNEL_NUMBER,                   \
                            RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_PACKET_LENGTH,              \
                            RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_STATE_AFTER_POWER_UP,       \
                            RADIO_CONFIGURATION_DATA_RTTY_30_RADIO_DELAY_CNT_AFTER_RESET       \
                            }
